    ...
    return (
      ...
      <h1>About Me</h1>
        <aboutme>
          ...
          <p>Upon realizing this, I decided to embark on my career transition into the software development industry, starting with a four-month long bootcamp program in San Diego. To you as the reader, there may seem to be a disconnection between full stack development and my background as a healthcare management consultant, but throughout my career I’ve always done a little bit of programming on the side, whether it was to create a complicated Microsoft Excel macro in VBA or to develop simple iPhone iOS applications in Swift. Programming, to me, gives me the perfect balance of utilizing the logical side of the brain and the creative side of the brain, and on that Avianca flight I had decided it was time to take this on as a full-time gig.</p>
          <p>Which leads to why I’m here. I’m hoping to use this medium to showcase my portfolio for software development and to interact with other innovators, developers, and individuals that are also passionate about changing the world. But I also hope to use this to share my experiences along the way.</p>
        </aboutme>
      </div>
    );
  }
